...
class QuestionsViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        guard let answerResults = segue.destination as? ResultsViewController else { return }
        answerResults.answerResults = sender as? [Answer]
    }
...
extension QuestionsViewController {
    ...
    private func nextQuestion() {
        ...
        performSegue(withIdentifier: "showResult", sender: answersChoosen)
    }
}
